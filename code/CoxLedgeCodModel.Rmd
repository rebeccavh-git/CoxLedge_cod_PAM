...
# Diel
plot(emm_h$hour, emm_h$presence)
plot(emm_h$hour, emm_h$rate)
#Lunar
plot(emm_l$Lunar, emm_l$presence)
plot(emm_l$Lunar, emm_l$rate)
# Seasonal
plot(emm_j$day, emm_j$presence)
plot(emm_j$day, emm_j$rate)
